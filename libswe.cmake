...
find_package(Boost 1.62 CONFIG QUIET OPTIONAL_COMPONENTS stacktrace_addr2line)
...
if(SWE_STACKTRACE)
    ...
    list(APPEND SWE_LINK_LIBRARIES ${Boost_STACKTRACE_ADDR2LINE_LIBRARIES})
endif()
...
if(SWE_SDL12)
    ...
    list(APPEND SWE_LINK_LIBRARIES X11)

    add_compile_options(${SDL_CFLAGS})
    add_link_options(${SDL_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDL_LIBRARIES})

    add_compile_options(${SDLGFX_CFLAGS})
    add_link_options(${SDLGFX_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDLGFX_LIBRARIES})
else()
    ...
    add_link_options(${SDL2_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDL2_LIBRARIES})
endif()


if(NOT SWE_DISABLE_AUDIO)
    add_compile_options(${SDLMIXER_CFLAGS})
    add_link_options(${SDLMIXER_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDLMIXER_LIBRARIES})
endif()

if(NOT SWE_DISABLE_IMAGE)
    add_compile_options(${SDLIMAGE_CFLAGS})
    add_link_options(${SDLIMAGE_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDLIMAGE_LIBRARIES})
endif()

if(NOT SWE_DISABLE_TTF)
    add_compile_options(${SDLTTF_CFLAGS})
    add_link_options(${SDLTTF_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDLTTF_LIBRARIES})
endif()

if(NOT SWE_DISABLE_NETWORK)
    add_compile_options(${SDLNET_CFLAGS})
    add_link_options(${SDLNET_LDFLAGS_OTHER})
    list(APPEND SWE_LINK_LIBRARIES ${SDLNET_LIBRARIES})
endif()
...
if(SWE_SDL12)
    ...
    add_link_options(${PNG_LDFLAGS_OTHER})
...
if(SWE_DLOPEN)
	...
	list(APPEND SWE_LINK_LIBRARIES dl)
    endif()
endif()
